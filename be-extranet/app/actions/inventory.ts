    ...
    52|    }
    53|
    54|    // 2. Mocking an update for ALL room types found for the next 7 days
    ...
    80|    return {
    81|        status: "success",
    82|        message: `Successfully updated availability for all ${roomTypes.length} room types from Channel Manager (Mock).`
    83|    };
    84|
